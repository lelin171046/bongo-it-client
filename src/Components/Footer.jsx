import { TableCellsMergeIcon, Telescope } from "lucide-react"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/bongoitfb" className="text-gray-400 hover:text-emerald-400 transition-colors">
              ...
              <a href="https://www.youtube.com/@YTCashCowbd" className="text-gray-400 hover:text-emerald-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/portfolio" className="text-gray-300 hover:text-emerald-400 transition-colors">
                  Portfolio
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>Email: promarketerraihan@gmail.com</li>
...
Rangpur City</li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2025 BongoIT-Rang. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
